    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950">
      <div className="bg-slate-800 border border-slate-700 rounded-xl shadow-lg p-8 max-w-sm w-full">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm text-slate-400 mt-1">Personal Finance & Accounting</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-slate-900 border border-slate-600 rounded-lg px-4 py-3 text-sm font-medium text-slate-200 hover:bg-slate-700 hover:border-slate-500 transition-colors"
        >
