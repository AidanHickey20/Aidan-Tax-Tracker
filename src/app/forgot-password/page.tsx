  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold text-slate-800 text-center mb-2">Reset your password</h1>
        ...
        {sent ? (
          <div className="bg-white border border-slate-200 rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-sm text-slate-400">Check your inbox and spam folder.</p>
            <Link href="/login" className="block mt-6 text-sm text-emerald-600 hover:text-emerald-700 font-medium">
              Back to login
            </Link>
          </div>
        ) : (
