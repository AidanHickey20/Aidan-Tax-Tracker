...
const PRO_ROUTES = new Set(["/", "/deals", "/bank-import"]);
...
const navItems: { href: string; label: string; icon: string; trialOnly?: boolean }[] = [
  ...
  { href: "/net-worth", label: "Net Worth", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
  ...
  { href: "/bank-import", label: "Bank Import", icon: "M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" },
